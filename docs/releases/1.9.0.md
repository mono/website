...
New mapping feature. This feature makes it easier to make your cross-platform applications work on many platforms without changing the configuration settings. More information can be found on [this page](http://mono-project.com/ASP.NET_Settings_Mapping). [Marek]
