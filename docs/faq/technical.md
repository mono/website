...
Mono currently runs on [Linux]({{ site.github.url }}/docs/about-mono/platforms/linux/), [Windows]({{ site.github.url }}/docs/getting-started/install/windows/), Solaris, [FreeBSD]({{ site.github.url }}/docs/about-mono/platforms/bsd/) and [MacOS X]({{ site.github.url }}/docs/about-mono/platforms/osx/). The Just-In-Time engine (JIT) is available on [x86]({{ site.github.url }}/docs/about-mono/platforms/x86/) and [PowerPC]({{ site.github.url }}/docs/about-mono/platforms/powerpc/), [Sparc]({{ site.github.url }}/docs/about-mono/platforms/sparc/) and S390 processors and can generate code and optimizations tailored for a particular CPU. Interpreters exist for the Itanium, HP-PA, StrongARM CPUs.
