...
This topic is covered in more detail in these two pages: [Best\_Practices]({{ site.github.url }}/old_site/Best_Practices "Best Practices") and [Responsive Applications]({{ site.github.url }}/docs/gui/gtksharp/responsive-applications/) pages for details on how to solve this issue.
