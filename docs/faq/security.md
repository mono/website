...
-   Implement a `ICertificatePolicy` class. By doing this you can override the normal results of the certificate validation (e.g. accepting an untrusted certificate). However you are now responsible of applying your own trust rules for your application. Further suggestions and source code are available in the [UsingTrustedRootsRespectfully]({{ site.github.url }}/archived/UsingTrustedRootsRespectfully "UsingTrustedRootsRespectfully") article.
...
There is an ongoing effort part of Mono called the [Crimson]({{ site.github.url }}/archived/Crimson "Crimson") project, you might want to contribute to that effort.
