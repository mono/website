...
-   Version 2.0 of the [embedding API](/docs/advanced/embedding/#updates-for-mono-version-282b)
-   WCF Routing
...
Configuring+Running with LLVM is described at: [Mono\_LLVM](/Mono_LLVM)
