...
[![Monovsmonosgen thumb.png]({{ site.github.url }}/archived/images/5/5e/Monovsmonosgen_thumb.png)]({{ site.github.url }}/archived/images/5/5e/Monovsmonosgen_thumb.png)
...
Configuring+Running with LLVM is described at: [Mono\_LLVM]({{ site.github.url }}/Mono_LLVM)
