...
New mapping feature. This feature makes it easier to make your cross-platform applications work on many platforms without changing the configuration settings. More information can be found on [this page]({{ site.github.url }}/ASP.NET_Settings_Mapping). [Marek]
...
> Source code and pre-compiled packages for Linux, Solaris, MacOS X and Windows is available from our web site from the [download]({{ site.github.url }}/Downloads) section.
