...
For more details about the compiler see our [C\# Compiler Page]({{ site.github.url }}/CSharp_Compiler)
...
For more information see our detailed list of [supported platforms]({{ site.github.url }}/Supported_Platforms).
...
For more information about profiling see the [performance tips]({{ site.github.url }}/Performance_Tips) page.
...
-   mod\_mono now supports auto-hosting of web sites, greatly reducing configuration of ASP.NET with Apache. See [our auto-configuration]({{ site.github.url }}/AutoConfiguration) page for more details.
