...
-   mod\_mono now supports auto-hosting of web sites, greatly reducing configuration of ASP.NET with Apache. See [our auto-configuration](/AutoConfiguration) page for more details.
