...
### mod\_mono [Auto-Configuration]({{ site.github.url }}/AutoConfiguration)
...
mod\_mono 1.1.10 features a new [auto-configuration]({{ site.github.url }}/AutoConfiguration) system which allows ASP.NET applications to work without having to make any configuration changes to Apache.
...
The feature can be turned off if desired, see our [documentation page]({{ site.github.url }}/AutoConfiguration) for more details.
