...
Mono 2.4.3 is a bugfix release for Mono 2.4, a follow up to [Release\_Notes\_Mono 2.4.2](/docs/about-mono/releases/2.4.2 "Release Notes Mono 2.4.2") which is the foundation for Novell's own long-term support Mono-based product.
