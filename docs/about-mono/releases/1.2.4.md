...
Beta: [Mono.DataConvert]({{ site.github.url }}/Mono_DataConvert)
----------------------------------------------------------------------

We are shipping a new class: [Mono.DataConvert]({{ site.github.url }}/Mono_DataConvert) that can be used for doing data conversion from native types into byte arrays and back, as well as providing little and big endian conversions in the process.
...
Documentation and examples are available [here]({{ site.github.url }}/Mono_DataConvert) [Miguel de Icaza].
