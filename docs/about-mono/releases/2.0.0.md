...
-   The mono\_method\_get\_unmanaged\_thunk () function has been implemented for developers [embedding Mono](/docs/advanced/embedding/) which simplifies calling managed methods from unmanaged code.
