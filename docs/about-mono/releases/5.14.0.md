...
Mono sgen GC didn't scan properly very large objects due to a bug in our code. Usually, objects which are over 4GBs of memory could exhibit such behaviour which could potentioally lead to random crashes for very large objects.
