...
*   [New code generation engine:](#new-code-generation-endgine) The new code generation engine is the core of the Mono JIT, and now also features a code pre-compiler.
...
*   [Windows.Forms:](#windows-forms) Lots of updates, and System.Drawing progress.
