...
Mono 2.8.1 is a bug fix release for [Mono 2.8]({{ site.github.url }}/docs/about-mono/releases/2.8.1 "Release Notes Mono 2.8.1") that contains the major fixes for bugs that were identified in Mono 2.8, it also contains a few security fixes.
...
This documents the changes since [Mono 2.8]({{ site.github.url }}/docs/about-mono/releases/2.8.0/ "Release Notes Mono 2.8"), the list was obtained by using:
