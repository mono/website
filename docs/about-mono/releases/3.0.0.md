...
We will continue to bug fix and update [Mono 2.10]({{ site.github.url }}/docs/about-mono/releases/2.10.0) for another six months for users that can not upgrade to Mono 3.0.
