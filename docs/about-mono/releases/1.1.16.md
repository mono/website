...
Paolo's new Generational GC has been integrated into Mono, but it is not currently supported. Documentation is available in [Compacting\_GC](/Compacting_GC) and docs/precise-gc.
