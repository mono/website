...
Mono 3.8.0 tem  711 commits desde o último release. Este é o trabalho de 61 contribuidores desde 28 de Maio. 58 bugs foraqm corrigidos.

Highlights
----------

- Maior performance e escalabilidades melhorias em todo o runtime.
- Terminando o port para Windows 64.
- Protocolo do Debugger otimizado para conexões USB.
...
- O JIT agora lida melhor com restos de  potências de dois, gerando código significativamente melhor.
- Código 10x mais rápido é gerado para os delegates que são chamados uma vez. Recursos C#, como assíncrona e LINQ produz uma grande quantidade desses delegates, esta melhoria vai afetar a todos.
- Análise melhorada agora pode lidar com aliases de segunda ordem e eliminar cheques nulos.
- O runtime agora tem uma tabela hash simultaneamente legível que pode fazer reflexão das cargas de trabalho pesadas significativamente mais rápido e mais escalável.

Garbage Collection
------------------

- Otimizado uma das estruturas do coletor de lixo de dados básicos devem resultar em 5 a 10% de redução no tempo de coleta.
