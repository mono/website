...
Jonathan Pobst released the [Mono Migration Analysis]({{ site.github.url }}/Moma) tool as part of the Mono 1.2 launch, and we were able to get a tremendous amount of feedback on what features people depended on.
