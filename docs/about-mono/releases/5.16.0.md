...
The single-precision math operations are now available in a new `System.MathF` class. Together with the `-O=float32` option, this can be used to improve the performance in floating point code.
