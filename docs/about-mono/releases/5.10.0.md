...
The Mono incompatibility nuget assemblies list was extended and updated which should help with nugets which bundle same assemblies as installed by Mono.
