...
Mono 2.10.1 is a minor update to [Mono 2.10](/docs/about-mono/releases/2.10.0/ "Release Notes Mono 2.10") based on the mono-2-10 branch of github. Mono 2.10.1 was released on February 25, 2011.
