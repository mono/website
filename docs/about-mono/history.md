...
-   [Mono and GNOME, the long reply](http://mail.gnome.org/archives/gnome-hackers/2002-February/msg00031.html) [Local Copy]({{ site.github.url }}/archived/mailpostlongreply "Mailpost:longreply")
-   [Mono early history](http://lists.ximian.com/archives/public/mono-list/2003-October/016345.html) [Local Copy]({{ site.github.url }}/archived/mailpostearlystory "Mailpost:earlystory")
