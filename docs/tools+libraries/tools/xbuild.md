...
You can see some tips for [Porting MSBuild Projects To XBuild]({{ site.github.url }}/archived/Porting_MSBuild_Projects_To_XBuild "Porting MSBuild Projects To XBuild").
