...
The linker operates only at the assemblies level. By using the [mkbundle](/docs/tools+libraries/tools/#project-converstion--deployment) program, you can create a single executable which will contain the strict minimum it needs to run.
