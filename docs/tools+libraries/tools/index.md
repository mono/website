...
-   [Gendarme](/docs/tools+libraries/tools/gendarme/): Rule-based assembly analyser for developpers.
-   [Monoxide](/archived/monoxide "Monoxide"): Interactive assembly analyser.
...
-   [monodocer](/docs/tools+libraries/tools/monodocer/): Generates documentation out of assemblys.
