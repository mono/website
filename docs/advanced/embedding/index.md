...
[![Existing.png]({{ site.github.url }}/archived/images/f/fa/Existing.png)]({{ site.github.url }}/archived/images/f/fa/Existing.png)
...
[![Linked.png]({{ site.github.url }}/archived/images/8/87/Linked.png)]({{ site.github.url }}/archived/images/8/87/Linked.png)
...
[![Loaded.png]({{ site.github.url }}/archived/images/2/2b/Loaded.png)]({{ site.github.url }}/archived/images/2/2b/Loaded.png)
...
The other option is to use the [Platform Invoke]({{ site.github.url }}/docs/advanced/pinvoke/) (P/Invoke) to call C code from the CIL universe, using the standard P/Invoke mechanisms.
