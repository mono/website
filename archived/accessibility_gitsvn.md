...
This is all documented in our [git-svn daily workflow](/Accessibility:_GitSVN:_Workflow "Accessibility: GitSVN: Workflow"). Please read it very carefully, as it explains how to update, edit, handle reviews, and commit.
