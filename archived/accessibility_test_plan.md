...
[Product Test Plan]({{ site.github.url }}/Accessibility:_Test_Plan "Accessibility: Test Plan") (current page)
 ...
 [Product Test Coding Standard]({{ site.github.url }}/Accessibility:_Test_Coding_Standard "Accessibility: Test Coding Standard")
...
[June 5 2008]({{ site.github.url }}/Accessibility:_QA_Meetings_2008_Jun_5 "Accessibility: QA Meetings 2008 Jun 5")
 [August 13 2008]({{ site.github.url }}/Accessibility:_QA_Meetings_2008_Aug_13 "Accessibility: QA Meetings 2008 Aug 13")
 [Mar 25 2009]({{ site.github.url }}/Accessibility:_QA_Meetings_2009_Mar_25 "Accessibility: QA Meetings 2009 Mar 25")
 [May 20 2009]({{ site.github.url }}/Accessibility:_QA_Meetings_2009_May_20 "Accessibility: QA Meetings 2009 May 20")
...
[UIA](http://msdn2.microsoft.com/en-us/accessibility/bb892133.aspx)---Microsoft UI Automation. A managed code application programming interface (API), exposing user interface controls for test automation and assistive technology. Part of the .NET framework starting at 3.0. Successor of MSAA (Microsoft Active Accessibility)
 ...
 [WinForms]({{ site.github.url }}/WinForms "WinForms")---One of the many GUI Toolkits for use with Mono, working towards compatibility with Microsoft's System.Windows.Forms.
...
-   Make mono [WinForms]({{ site.github.url }}/WinForms "WinForms") accessible. All WinForms currently supported by mono.
-   Make [Moonlight]({{ site.github.url }}/Moonlight "Moonlight") accessible
-   Allow [UI Automation]({{ site.github.url }}/UI_Automation "UI Automation") based Accessibility Technologies to run on Linux
...
According to Q2 2008 of the [Accessibility\#Roadmap roadmap]({{ site.github.url }}/Accessibility#roadmap-roadmap "Accessibility"), testing contents need relate with below info:
...
-   WinForms samples will be created in C\#, Boo, or IronPython(here we chose IronPython). Automation scripts, that test the accessibility of the WinForms apps will be created in CPython. [Strongwind]({{ site.github.url }}/Accessibility:_Testing_Howto#strongwind "Accessibility: Testing Howto") and [Orca Regression Tests]({{ site.github.url }}/Accessibility:_Testing_Howto#orca "Accessibility: Testing Howto") will be used for the automation scripts.
...
Individual test case pass/fail criterion is defined by the automated script which performs the testing. Upon failure of a test case, the script should will log the failure. For exit criteria, see [Approach]({{ site.github.url }}/Accessibility:_Test_Plan#approach "Accessibility: Test Plan").
...
*Built around the [roadmap]({{ site.github.url }}/Accessibility:_Roadmap "Accessibility: Roadmap") but specific to testing with testing milestones*
