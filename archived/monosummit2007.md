...
-   [Agenda]({{ site.github.url }}/Mono_Summit_2007_Schedule "Mono Summit 2007 Schedule")
...
This includes Mono, [Moonlight]({{ site.github.url }}/Moonlight "Moonlight") and [Olive]({{ site.github.url }}/Olive "Olive") as well as discussing future developments.
...
The current agenda is available [here]({{ site.github.url }}/Mono_Summit_2007_Schedule "Mono Summit 2007 Schedule"), but it is still a work in progress. Please submit any topic ideas to the mono-list@lists.ximian.com mailing list. [(Mailing List info)]({{ site.github.url }}/Mailing_Lists "Mailing Lists")
