...
A mutiliated version of Jamie Zawinksi's irc2html.pl that creates basic MediaWiki tables instead of HTML. Used by the [Accessibility Team]({{ site.github.url }}/Accessibility:_Team "Accessibility: Team") to post IRC meeting logs. Works great with irssi log format; can't speak for anything else.
