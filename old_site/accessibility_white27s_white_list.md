...
<ul>
<li><a href="#White.27s_white_list">1 White's white list</a>
<ul>
<li><a href="#Introduction">1.1 Introduction</a>
<ul>
<li><a href="#What.27s_White.3F">1.1.1 What's White?</a></li>
<li><a href="#Why_our_QAs_need_White.3F">1.1.2 Why our QAs need White?</a></li>
<li><a href="#What.27s_the_risk_for_writing_test_samples_with_White">1.1.3 What's the risk for writing test samples with White</a></li>
<li><a href="#What.27s_the_white_list_for_White">1.1.4 What's the white list for White</a></li>
</ul></li>
<li><a href="#White.27s_white_list_2">1.2 White's white list</a>
<ul>
...
-   All types in Core.UIItemEvents namespace
    -   Though in the static ctor of many \*Event classes, native Win32 APIs are called, but they are just used to set the event name, and I don't think they will cause the risk mentioned in [\#What's the risk for writing test samples with White](#What.27s_the_risk_for_writing_test_samples_with_White)
