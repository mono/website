...
permalink: /old_site/Release_Notes_Mono_2.6/
redirect_from:
  - /Release_Notes_Mono_2.6/
---

Release Notes Mono 2.6
======================
...
Mono 2.6 features a new debugger engine, the Mono [Soft Debugger]({{site.github.url}}/old_site/Mono:Runtime:Documentation:SoftDebugger "Mono:Runtime:Documentation:SoftDebugger").
